 ...
 * The idea is to encapsulate the request body needed to create a TourRating
 * Where the customer needed to pass a entire tour insted of a tourId
 * The below code fix that
 */
